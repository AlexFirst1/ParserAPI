        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Task>().HasData(
               new Task[]
               {
                   ...
                   new Task { TaskId=2, Name="Создать задачу", Content="Описание", DateCreated = DateTime.Now, Status=StatusTask.InProcess, DirectorUserId = 1, ExecutorUserId=2},
                   ...
                   new Task { TaskId=7, Name="Создать задачу", Content="Описание", DateCreated = DateTime.Now, Status=StatusTask.InProcess, DirectorUserId = 1, ExecutorUserId=2},
                   ...
                   new Task { TaskId=10, Name="Создать задачу", Content="Описание", DateCreated = DateTime.Now, Status=StatusTask.InProcess, DirectorUserId = 1, ExecutorUserId=2},
                   ...
                   new Task { TaskId=14, Name="Создать задачу", Content="Описание", DateCreated = DateTime.Now, Status=StatusTask.InProcess, DirectorUserId = 1, ExecutorUserId=2},
                   ...
                   new Task { TaskId=17, Name="Создать задачу", Content="Описание", DateCreated = DateTime.Now, Status=StatusTask.InProcess, DirectorUserId = 1, ExecutorUserId=2},
                   new Task { TaskId=18, Name="Создать задачу", Content="Описание", DateCreated = DateTime.Now, Status=StatusTask.InProcess, DirectorUserId = 1, ExecutorUserId=2},
                   new Task { TaskId=19, Name="Создать задачу", Content="Описание", DateCreated = DateTime.Now, Status=StatusTask.InProcess, DirectorUserId = 1, ExecutorUserId=2},
                   new Task { TaskId=20, Name="Создать задачу", Content="Описание", DateCreated = DateTime.Now, Status=StatusTask.InProcess, DirectorUserId = 1, ExecutorUserId=2},
                   new Task { TaskId=21, Name="Создать задачу", Content="Описание", DateCreated = DateTime.Now, Status=StatusTask.InProcess, DirectorUserId = 1, ExecutorUserId=2},
                   new Task { TaskId=22, Name="Создать задачу", Content="Описание", DateCreated = DateTime.Now, Status=StatusTask.InProcess, DirectorUserId = 1, ExecutorUserId=2},
                   new Task { TaskId=23, Name="Создать задачу", Content="Описание", DateCreated = DateTime.Now, Status=StatusTask.InProcess, DirectorUserId = 1, ExecutorUserId=2},
                   new Task { TaskId=24, Name="Создать задачу", Content="Описание", DateCreated = DateTime.Now, Status=StatusTask.InProcess, DirectorUserId = 1, ExecutorUserId=2},
